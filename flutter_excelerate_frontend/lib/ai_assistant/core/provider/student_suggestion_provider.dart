...
class StudentSuggestionProvider implements SuggestionProvider {
  ...
  List<String> generateSuggestions(
    ...
    if (context.programsContext != null &&
        context.programsContext!.activePrograms.isNotEmpty) {
      _addProgramSuggestions(suggestions, context.programsContext!);
    }

    if (context.assignmentsContext != null &&
        context.assignmentsContext!.pendingCount > 0) {
  ...
  void _addScreenContextSuggestions(
  ...
  void _addAssignmentSuggestions(
    Set<String> suggestions,
